...
void SprdVideoEncoderOMXComponent::updatePortParams() {
...
OMX_ERRORTYPE SprdVideoEncoderOMXComponent::internalSetPortParams(
...
OMX_ERRORTYPE SprdVideoEncoderOMXComponent::internalSetParameter(
    ...
    switch (indexFull) {
        ...
        case OMX_IndexParamPortDefinition:
        {
            ...
            return SprdSimpleOMXComponent::internalSetParameter(index, param);
        }
...
OMX_ERRORTYPE SprdVideoEncoderOMXComponent::internalGetParameter(
    ...
    switch (index) {
        ...
        default:
            return SprdSimpleOMXComponent::internalGetParameter(index, param);
    }
}

// static
void SprdVideoEncoderOMXComponent::ConvertFlexYUVToPlanar(
...
// static
void SprdVideoEncoderOMXComponent::ConvertYUV420SemiPlanarToYUV420Planar(
...
// static
void SprdVideoEncoderOMXComponent::ConvertRGB32ToPlanar(
...
const uint8_t *SprdVideoEncoderOMXComponent::extractGraphicBuffer(
